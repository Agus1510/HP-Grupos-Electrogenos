...
export const ContactUs = () => {
  ...
  return (
    <form ref={form} onSubmit={sendEmail} className={style.form}>
      ...
      <input type="tel" name="to_phone" id="to_phone" />
      <label>Mensaje</label>
    ...
    <div className={style.container} id="contacto">
      <div className={style.flexContainer}>
        ...
        <iframe
          ...
          title="Ubicacion HP Grupos Electrogenos"
        ...
        <div className={style.contact}>
          <div className={style.text}>
            ...
            <a href="tel:7553-0519">Tel: 7553-0519</a>
          ...
          <div className={style.text}>
            ...
            <p>
              ...
              7553-0519 o completa el formulario a continuación
            </p>
            <ContactUs />
          </div>
        </div>
